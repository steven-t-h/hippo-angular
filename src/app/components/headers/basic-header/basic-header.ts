      ...
      <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        <div class="flex flex-1">
          ...
          <div class="flex lg:hidden">
            <button type="button" (click)="openNav()" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
        ...
        <div role="dialog" aria-modal="true" class="lg:hidden">
          ...
          <div class="fixed inset-y-0 left-0 z-10 w-full overflow-y-auto bg-white px-6 py-6">
            <div class="flex items-center justify-between">
              <div class="flex flex-1">
                <button type="button" (click)="closeNav()" class="-m-2.5 rounded-md p-2.5 text-gray-700">
            ...
            <div class="mt-6 space-y-2">
              <a routerLink="/shop" (click)="closeNav()"
...
export class BasicHeader {
  private navOpen = signal<boolean>(false);
  isNavOpen = computed(() => this.navOpen());
